...
def connect_google_sheet():
    try:
        ...
        # \n को असली न्यूलाइन में कनवर्ट करना
        raw_json_credentials["private_key"] = raw_json_credentials["private_key"].replace(r"\n", "\n")
